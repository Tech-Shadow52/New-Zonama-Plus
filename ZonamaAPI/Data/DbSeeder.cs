...
public static class DbSeeder
{
    public static async Task SeedAsync(ZonamaDbContext db)
    {
        ...
        var products = new List<Product>
        {
            ...
            // El Salvador local products
            new() { SellerId = systemSeller.Id, Title = "Café Salvadoreño Premium", Price = 12.99m, Category = ProductCategory.Other, Brand = "Finca El Volcán", ImageUrl = "https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=400&h=300&fit=crop&auto=format", Description = "Café 100% arábica cultivado en las montañas de El Salvador. Tostado artesanal con notas de chocolate y caramelo.", Stock = 60, Rating = 4.8, IsFeatured = true },
            new() { SellerId = systemSeller.Id, Title = "Artesanía de Barro Negro", Price = 25.00m, Category = ProductCategory.Other, Brand = "Artesanos de Ilobasco", ImageUrl = "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop&auto=format", Description = "Hermosa pieza de cerámica tradicional salvadoreña hecha a mano en Ilobasco.", Stock = 15, Rating = 4.9, IsFeatured = true },
            new() { SellerId = systemSeller.Id, Title = "Hamaca Salvadoreña Tejida", Price = 45.00m, Category = ProductCategory.Home, Brand = "Textiles Tradicionales SV", ImageUrl = "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop&auto=format", Description = "Hamaca tradicional tejida a mano por artesanos salvadoreños. Colores vibrantes y máxima comodidad.", Stock = 20, Rating = 4.7 },
        };
